...
```
[vagrant@docker-node1 ~]$ sudo service docker stop
[vagrant@docker-node1 ~]$ sudo /usr/bin/dockerd -H tcp://0.0.0.0:2375 \
...
```
[vagrant@docker-node2 ~]$ sudo service docker stop
[vagrant@docker-node2 ~]$ sudo /usr/bin/dockerd -H tcp://0.0.0.0:2375 \
> -H unix:///var/run/docker.sock \
